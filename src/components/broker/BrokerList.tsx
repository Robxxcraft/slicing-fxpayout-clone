  ...
  return (
    <>
      ...
      <div className="mt-6 md:mt-8 2xl:mt-10 px-5 w-full flex items-center justify-center gap-3 md:gap-4">
        <Link
          to="#"
          className="size-10 text-base flex justify-center items-center border-[rgba(255,255,255,0.5)] rounded-[15px]">
          ...
          if (item === "1") {
            return (
              <Link
                to="#"
                key={item}
                className="size-10 flex justify-center items-center bg-linear-to-t from-dark-primary to-primary border border-[rgba(255,255,255,0.5)] text-base font-semibold text-white rounded-[15px]">
                {item}
              </Link>
            );
          }
