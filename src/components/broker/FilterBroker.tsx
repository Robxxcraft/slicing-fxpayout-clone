    ...
    <div className="px-6 md:px-11 lg:px-18 xl:px-24 3xl:px-56 flex flex-col items-center justify-center text-center">
      ...
      <div className="mt-4 lg:mt-6 w-full flex items-center gap-2 md:gap-4 lg:gap-6">
        {query !== undefined && onHandleSearch !== undefined &&
          <div className="py-4 3xl:py-6 px-5 flex items-center gap-4 w-full bg-white border border-[#D0D5DD] rounded-full">
        ...
        <Button 
          ...
          className="py-4! 3xl:py-6! px-4! md:px-8! shrink-0"
        >
          <p className="hidden md:block text-base 3xl:text-xl leading-6 font-normal">
      ...
      <div className="mt-4 lg:mt-6 w-full flex flex-col-reverse md:flex-row items-start md:items-center justify-between gap-2.5">
        <p className="text-base 3xl:text-xl leading-6">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 w-full md:w-fit">
          <div className="shrink-0 flex items-center gap-2">
            <BsSortDown className="text-lg 3xl:text-2xl" />
            <p className="text-base 3xl:text-xl leading-6 text-black/80">
