    ...
    <section className="px-5 xl:px-24 2xl:px-56 pt-18 xl:pt-[120px] 2xl:pt-56">
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 items-center">
        <div className="order-2 xl:order-1 p-4 md:p-8 2xl:p-[42px] w-full bg-[#F9F8F4] rounded-[30px] md:rounded-[40px]">
          <div className="py-3 2xl:py-6 px-5 flex items-center gap-4 w-full bg-white border border-[#D0D5DD] rounded-full">
          ...
          <div className="my-6 flex flex-wrap gap-x-2 gap-y-3">
            {[
              ...
              <div
                key={idx}
                className="px-6 py-3 bg-[#E3EBFF] border border-primary rounded-full">
          ...
          <div className="flex flex-col gap-4">
            {featuresProfile.map((item, idx) => (
              <div
                key={idx}
                className="p-4 flex gap-4 w-full bg-[rgba(11,24,37,0.02)] border border-[rgba(0,0,0,0.1)] rounded-2xl">
        ...
        <div className="order-1 xl:order-2">
          <div className="px-6 py-4 flex flex-col md:flex-row items-center gap-x-4 gap-y-2 bg-primary rounded-full w-fit">
          ...
          <h2 className="font-wix-madefor-display my-8 text-[28px] md:text-[50px] 2xl:text-[64px] font-bold leading-[120%]">
            RebateFX, rujukan utama rebate forex bagi trader Indonesia.
          </h2>
          <p className="text-base md:text-lg 2xl:text-2xl font-medium text-[rgba(0,0,0,0.8)] leading-[200%]">
