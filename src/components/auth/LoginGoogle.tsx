...
const LoginGoogle = ({ role, status }: { role?: string, status: "signin" | "signup" }) => {
  ...
  return (
    <div 
      className="relative mt-8 py-2 flex justify-center gap-4 w-full border border-black/60 rounded-lg cursor-pointer hover:bg-black/5 active:bg-black/10 transition-all duration-300 overflow-hidden"
    >
      <GoogleLogin 
