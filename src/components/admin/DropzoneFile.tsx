...
const DropzoneFile = ({
  ...
  return (
    <div {...getRootProps()} className="relative">
      <div
        className="px-4 flex flex-col items-center justify-center w-full h-[200px] rounded-2xl cursor-pointer text-center"
        style={{ 
      ...
      >
        ...
        {isDragActive ?
          ...
          :
          <>
            <span className="text-sm 2xl:text-base text-black/80 font-medium">Klik atau geser file ke sini untuk mengunggah</span>
            <span className="text-sm 2xl:text-base text-black/60">Pastikan file berformat .csv dengan ukuran maksimal 5MB.</span>
          </>
        }
        <input {...getInputProps()} />
      </div>
