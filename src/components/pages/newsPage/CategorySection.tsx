    ...
    <>
      <section className="px-6 md:px-11 lg:px-18 xl:px-24 2xl:px-56 pt-10 md:pt-15 2xl:pt-20">
        <div className="flex justify-between">
          <h2 className="text-xl md:text-[32px] lg:text-3xl 2xl:text-[32px] font-semibold leading-[132%]">
      ...
      <section className="px-6 md:px-11 lg:px-18 xl:px-24 2xl:px-56 pt-10 md:pt-15 2xl:pt-20">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 md:gap-15 lg:gap-6 2xl:gap-10">
          <div>
            <div className="flex justify-between">
              <h2 className="text-xl md:text-[32px] lg:text-3xl 2xl:text-[32px] font-semibold leading-[132%]">
