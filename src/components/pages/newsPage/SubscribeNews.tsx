          ...
          <div className="flex flex-col md:flex-row items-center gap-2 max-w-full lg:max-w-1/2">
            <div className="relative w-full">
              ...
              <input
                ...
                autoComplete="email"
                className={`
                  pl-[70px] pr-8 py-5 md:py-4 2xl:py-5 w-full bg-white text-base 2xl:text-xl placeholder:text-[#747474] rounded-full focus:outline-primary disabled:bg-black/5 disabled:cursor-not-allowed`
                }
              />
            </div>
