...
const HotNews = () => {
  ...
  return (
    <div className="p-5 md:p-10 relative w-full min-h-[470px] rounded-xl overflow-hidden bg-[url('/news/a6a30dfd6bffeb2ee9a2d236f310e96f5a70450f.png')] bg-cover bg-center">
      ...
      <div className="p-5 md:p-8 3xl:p-10 absolute inset-0 z-999 flex flex-col justify-between">
        <div className="px-4 3xl:px-6 py-2 3xl:py-2.5 w-fit flex items-center gap-2.5 border border-white bg-primary rounded-full">
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-4 text-white">
            ...
            <div>
              <p className="mb-2 md:mb-4 w-full lg:max-w-3xl text-base md:text-lg 3xl:text-xl leading-[163%] line-clamp-3">
              ...
              <Link to="#" className="flex items-center gap-1 text-base md:text-lg 3xl:text-xl font-medium hover:underline">
