...
const DefinitionSection = ({ 
  ...
  return (
    <section
      ...
      className="px-6 md:px-11 xl:px-0 xl:pe-24 3xl:pe-56 scroll-mt-[136px] lg:scroll-mt-[120px] pb-8 md:pb-10 lg:pb-0"
    >
      <h2 className="font-medium text-2xl md:text-[2rem] 3xl:text-[2.5rem]">
        {t("claimrebatepage:definition.title")}
      </h2>
      <div className="my-6 3xl:my-8 py-5 lg:py-6 flex flex-col justify-center items-center gap-2 w-full bg-linear-to-t from-dark-primary to-primary rounded-3xl">
        <img src="/fxpayout-white.svg" alt="Logo FXPayout" className="h-16" />
        <p className="font-semibold text-2xl text-white">Rebate Forex</p>
      </div>
      <p className="text-xl 3xl:text-2xl leading-[169.2%]">
        ...
        {cards.map((item, index) => (
          <div
            ...
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-semibold text-xl 3xl:text-2xl text-[#222222]">
                {t(`${item.keyTranslation}.title`)}
              </h3>
            </div>
            <p className="mt-3 text-xl 3xl:text-2xl leading-[169.2%]">
