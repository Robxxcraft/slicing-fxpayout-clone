        ...
        {comparisonData.map((item, index) => {
          return (
            <React.Fragment key={index}>
              ...
              `}>
                <div className="p-2 2xl:p-4 shrink-0 size-11 md:size-12 2xl:size-16 flex items-center justify-center rounded-lg bg-my-light-blue">
                ...
                <div>
                  <h4 className="text-base md:text-xl 2xl:text-2xl font-semibold leading-[160%]">
              ...
              `}>
                {item.fxPayout.icon ? (
                  ...
                  <div className="px-3 md:px-6 lg:px-8 py-2 md:py-3 bg-linear-to-t from-dark-primary to-primary rounded-[20px]">
                    <p className="text-xs md:text-xl 2xl:text-2xl font-semibold text-white leading-[160%]">
                      {item.fxPayout.data}
                    </p>
                  </div>
                )}
              ...
              `}>
                ...
                `}>
                  {typeof item.other === "boolean" ? (
                    ...
                    <p className="text-sm md:text-xl 2xl:text-2xl font-medium text-black/50 leading-[160%]">
