      ...
      <div className="_no-scrollbar mt-6 md:mt-10 p-1 md:p-2 w-full lg:w-fit bg-primary/8 border border-primary rounded-full overflow-auto">
        <div className="flex gap-1 md:gap-6">
          ...
          <Link
            ...
            className="py-3 2xl:py-4 px-5 md:px-3 lg:px-8 2xl:px-12 flex justify-center items-center w-full lg:w-fit rounded-full cursor-pointer transition-all duration-300 bg-transparent"
          >
            <p className="text-sm md:text-base lg:text-lg 2xl:text-2xl font-medium text-wrap xl:text-nowrap text-transparent bg-linear-to-t from-dark-primary to-primary bg-clip-text">
