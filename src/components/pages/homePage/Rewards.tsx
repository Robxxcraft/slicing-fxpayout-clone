...
const Rewards = () => {
  ...
  return (
    <div className="relative mt-10 lg:mt-18 3xl:mt-28 px-6 xl:px-[120px] 3xl:px-[166px] py-8 3xl:py-10 bg-primary overflow-hidden">
      <img
      ...
      <div className="z-999 relative flex flex-col xl:flex-row gap-x-8 gap-y-6 lg:gap-y-8 items-center justify-between">
        <div className="flex flex-row gap-2 lg:gap-5 3xl:gap-6 w-full xl:w-fit">
          ...
          <div className="w-full">
            <div className="mb-2 lg:mb-3 flex flex-row md:items-center justify-between xl:justify-start gap-x-6">
              <h2 className="text-base md:text-xl lg:text-[26px] 3xl:text-[32px] font-semibold text-white">
                {t("homepage:rewards.title")}
              </h2>
              <div className="h-fit">
                <div className="px-4 md:px-6 lg:px-5 py-1.5 3xl:py-2.5 flex items-center gap-2.5 w-fit border border-[#FF929D] rounded-full">
            ...
            <p className="text-sm md:text-base 3xl:text-xl font-semibold text-[rgba(255,255,255,0.8)]">
              {t("homepage:rewards.paragraph")}
            </p>
          </div>
        </div>
        <Button buttonType="link" urlTo={getLocalizedPath("/register", i18n.language)} target="_blank" variant="light" size="xl" className="py-4! 3xl:py-6! font-medium! w-full! xl:w-fit!">
