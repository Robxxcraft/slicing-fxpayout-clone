  ...
  return (
    <section className="px-6 md:px-10 lg:px-18 xl:px-24 3xl:px-56 pt-10 md:pt-14 xl:pt-[120px]">
      <div className="relative pt-[72px] pb-8 md:pb-[72px] px-6 md:px-10 lg:px-16 bg-primary rounded-3xl">
        ...
        <h2 className="text-2xl md:text-[32px] 3xl:text-[40px] font-semibold md:font-bold leading-[132%] text-white">
        ...
        <div onContextMenu={() => false} className="z-95 hidden xl:block absolute end-1 top-1/2 -translate-y-1/2 w-[320px] 3xl:w-[420px] select-none pointer-events-none">
          <img src="/secure-fxpayout.webp" alt="Secure FXPayout" 
            className="w-full object-contain"
          />
        </div>
