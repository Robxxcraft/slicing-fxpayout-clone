  ...
  return (
    <section className="px-6 md:px-10 lg:px-18 xl:px-24 3xl:px-56 pt-10 md:pt-14 xl:pt-[120px]">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <div className="mt-6 md:mt-10 px-6 3xl:px-10 py-4 3xl:py-6 flex items-center gap-4 bg-primary/7 border border-primary rounded-2xl">
          <img src="/check-gradient.svg" alt="check icon"
            className="mt-px scale-70 md:scale-80 3xl:scale-90"
          />
          <p className="text-base md:text-xl 3xl:text-2xl font-medium leading-6 -tracking-[-0.24%] text-transparent bg-linear-to-t from-dark-primary to-primary bg-clip-text">
