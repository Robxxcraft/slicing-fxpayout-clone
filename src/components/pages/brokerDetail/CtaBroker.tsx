...
const CtaBroker = () => {
  return (
    <section className="px-5 xl:px-24 2xl:px-56 pt-18 xl:pt-20">
      <div className="relative py-10 xl:py-14 2xl:py-[72px] px-4 xl:px-10 flex flex-col items-center justify-center bg-primary rounded-3xl text-center overflow-hidden">
        <div className="z-999 w-full flex flex-col items-center">
          <h2 className="text-[28px] md:text-[32px] 2xl:text-[40px] font-bold text-white leading-[134%] max-w-full">
            Siap Trading Dengan Exness?
          </h2>
          <p className="mt-2 md:mt-3 2xl:mt-4 text-base 2xl:text-xl text-white leading-[160%] max-w-[620px]">
            Gunakan link khusus Anda untuk mengakses rebate terbaik dan kondisi trading profesional di Exness.
          </p>
          <div className="mt-5 md:mt-6 2xl:mt-8 flex flex-col md:flex-row gap-4 md:gap-3">
