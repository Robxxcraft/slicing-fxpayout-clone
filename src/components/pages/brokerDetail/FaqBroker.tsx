...
const FaqBroker = ({ brokerId, faq }: { brokerId: string; faq: string }) => {
  ...
  return (
    <section id="faq" className="scroll-mt-18 lg:scroll-mt-0 mt-10 lg:mt-12 3xl:mt-16 py-8 md:py-10 3xl:py-14 px-5 md:px-11 lg:px-18 xl:px-24 3xl:px-56 bg-[#F9F9F9]">
      ...
      <div className='mt-6 3xl:mt-8 flex flex-col gap-2 lg:gap-3 3xl:gap-4'>
        {Array.isArray(dataFaq) && dataFaq.map((f, idx) => (
          <details key={idx} name="faq-broker" open={idx === 0}
            className='group rounded-2xl bg-white border border-[#D9DBE9] shadow-[0_5px_24px_0_rgba(65,96,255,0.23)] 3xl:shadow-[0_5px_31.4px_0_rgba(65,96,255,0.23)]'>
            ...
            <p className='px-8 mb-10 md:mb-8 3xl:mb-10 text-base md:text-xl leading-[180%] text-my-half-purple'>{f.answer}</p>
          </details>
        ))}
      </div>
    </section>
