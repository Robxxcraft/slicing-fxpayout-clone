...
const Spread = ({ tradingSpread }: { tradingSpread: SpreadStructure[] }) => {
  ...
  return (
    <section id="spread-commission" className="scroll-mt-26 lg:scroll-mt-0 mt-10 lg:mt-12 3xl:mt-16 px-6 md:px-11 lg:px-18 xl:px-24 3xl:px-56">
      ...
      <div className="mt-6 3xl:mt-8 flex flex-col md:flex-row gap-3 lg:gap-5 3xl:gap-6">
        {tradingSpread.map((item,idx) => (
          <div key={idx} className="p-6 3xl:p-8 max-w-full md:max-w-1/2 w-full border border-[#D0D0D0] bg-white rounded-3xl">
