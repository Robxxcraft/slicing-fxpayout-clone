  ...
  return (
    <div 
      ...
      className={`${wallet.status === "pending" ? "border-[#DDDDDD]" : wallet.status === "rejected" ? "border-[#DF1E1E]" : "border-primary"}
        mb-2 px-3 md:px-5 3xl:px-6 py-2.5 3xl:py-4 gap-3 flex items-center justify-between w-full lg:w-[420px] 3xl:w-[540px] lg:max-w-[420px] 3xl:max-w-[540px] rounded-lg border hover:bg-[#F5F5F5] transition-colors duration-300 cursor-pointer select-none`}
    >
      <div className="flex items-center gap-4 w-full">
        {wallet.method === "bank" ? 
          <>
            <BsBank2 className={`shrink-0 text-2xl 3xl:text-3xl
            ...
            <div className="w-full">
              <div className="flex gap-1 w-fit">
                <span className="text-base 3xl:text-xl font-semibold max-w-[200px] text-nowrap truncate">
                  {wallet.data.bank}
                </span>
                <span className="text-base 3xl:text-xl font-semibold max-w-[150px] text-nowrap truncate">
                  •••• {showLastFourWalletAddress(wallet.data.accountNumber)}
                </span>
              </div>
              
              <p className={`max-w-[280px] 3xl:max-w-[350px] text-sm 3xl:text-lg
          ...
          <>
            ...
            <div className="w-full">
              <div className="flex gap-1 w-fit">
                <span className="text-base 3xl:text-xl font-semibold max-w-[300px] text-nowrap truncate">
                  •••• {showLastFourWalletAddress(wallet.data.accountNumber)}
                </span>
              </div>
