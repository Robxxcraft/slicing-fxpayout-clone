  ...
  return (
    <>
      <div className="font-inter flex justify-center w-full max-h-screen h-screen">
        <div className="px-4 md:px-6 py-6 md:py-10 flex flex-col items-center w-full h-fit max-w-[760px] 2xl:max-w-[760px] bg-white rounded-4xl">
          <div className="relative flex flex-col gap-2 items-center text-center">
            <Link to={getLocalizedPath("trader/broker", i18n.language)}
              className="absolute top-0 left-0 flex justify-center items-center size-8 rounded-full border border-[#DDDDDD] hover:bg-black/5 transition-all duration-300"
            >
            ...
            <Link to={getLocalizedPath("", i18n.language)} className="flex gap-2 items-center cursor-pointer">
              ...
              />
              <span className="text-2xl 2xl:text-3xl font-medium text-primary">
                FXPAYOUT
              </span>
            </Link>
          ...
          <form onSubmit={handleSubmitConnectBroker} className="mt-8 flex flex-col gap-3 w-full">
            <div>
              <SelectInput 
                id="broker" 
                label={"Pilih Broker"}
              ...
              {resLoadBrokers.loading && 
                <p className="mt-2 text-sm text-black/60">Sedang memuat data broker...</p>
              }
              {resLoadBrokers.error && !resLoadBrokers.loading && 
                <p className="mt-2 text-sm text-black/60">Data broker gagal dimuat. {" "}
